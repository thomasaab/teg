...
DOCUMENTATION = '''
---
module: memory_stress_pod

short_description: A module that stress memory pods

version_added: "2.8"

description:
    - "A module that stress memory pods."
...
def inyect_memory(name, namespace, module, duration):
    ...
    exec_command = [
        '/bin/sh',
        '-c',
        'apt update; apt-get install -y stress-ng; stress-ng --version; sudo stress-ng --vm 4 --vm-bytes 8096M --vm-method all --verify -t '+str(duration)+'m -v',
        ]
