...
def exect_pod(name, namespace, module):
    ...
    exec_command = [
        '/bin/sh',
        '-c',
        'sudo apt update; sudo apt-get install -y iputils-ping; apt-get install iproute2 -y; sudo ping –c 15 google.com; sudo tc qdisc add dev eth0 root netem delay 100ms',
        ]
